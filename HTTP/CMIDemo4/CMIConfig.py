...
class Ui_Dialog(object):
    def setupUi(self, Dialog, Main):
        ...
        self.lineEdit.setText(CMIPublic.cmiconfig['cmiip'])
        self.verticalLayout_2.addWidget(self.lineEdit)
        self.lineEdit_2 = QtGui.QLineEdit(self.layoutWidget1)
        self.lineEdit_2.setObjectName(_fromUtf8("lineEdit_2"))
        self.lineEdit_2.setText(CMIPublic.cmiconfig['oracleurl'])
        self.verticalLayout_2.addWidget(self.lineEdit_2)
        self.lineEdit_3 = QtGui.QLineEdit(self.layoutWidget1)
        self.lineEdit_3.setObjectName(_fromUtf8("lineEdit_3"))
        self.lineEdit_3.setText(CMIPublic.cmiconfig['oracleuser'])
        self.verticalLayout_2.addWidget(self.lineEdit_3)
        self.lineEdit_4 = QtGui.QLineEdit(self.layoutWidget1)
        self.lineEdit_4.setObjectName(_fromUtf8("lineEdit_4"))
        self.lineEdit_4.setText(CMIPublic.cmiconfig['oraclepwd'])
    ...
    def save(self):
        ...
        self.Main.printLog(u'CMIIP:'+cmiip)
        self.Main.printLog(u'OracleUrl:'+oracleurl)
        self.Main.printLog(u'OracleUsr:'+oracleuser)
        self.Main.printLog(u'OraclePwd:'+oraclepwd)

        #刷新内存
        CMIPublic.cmiconfig['oracleurl']=oracleurl
        CMIPublic.cmiconfig['oracleuser']=oracleuser
        CMIPublic.cmiconfig['oraclepwd']=oraclepwd
