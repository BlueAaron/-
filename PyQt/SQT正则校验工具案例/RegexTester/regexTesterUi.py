...
# Form implementation generated from reading ui file 'SQT正则校验工具案例.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "SQT点餐系统案例 data:", None))
        ...
        self.checkBox_DM.setText(_translate("Dialog", "Dot matches all (SQT正则校验工具案例)", None))
